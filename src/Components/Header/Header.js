...
export default function Header() {
    return (
        <div>
            <HeaderIntro />
            <nav className="navbar navbar-expand-sm navbar-dark pb-0">
