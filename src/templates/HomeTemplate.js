                    ...
                    <div className="collapse navbar-collapse" id="collapsibleNavId">
                        <ul className="navbar-nav mr-auto mt-2 mt-lg-0 m-auto">
                            <li className="nav-item">
                                <NavLink activeClassName="active" className="nav-link active" to="/aboutme"><span>About Me</span></NavLink>
                            </li>
                            <li className="nav-item">
                            ...
                            <li className="nav-item download ml-lg-3">
                                <a href="https://drive.google.com/file/d/1_CjWxnfXQ16uRkUcyNFLU-P8DZlADFu9/view?usp=sharing" target="_blank" className="nav-link">
